...
parser.add_argument("-o", "--overwite", action='store_true', default = False,  
...
#                    print("Warning! Found already existing " + tag_add + " and \'overwrite\' is set to: " + over + ". We are going to overwrite.")
                    ...
                    sys.exit("Found already existing " + tag_add + " but 'overwrite' is set to False, not going to overwrite and exiting. Set 'overwrite' to True or choose a different flag to be added.")
            else:
